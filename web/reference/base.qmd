...
| Name | Description |
| --- | --- |
| [Vibration](#pyvib.base.Vibration) | Main Vibraion class |

### Vibration { #pyvib.base.Vibration }
...
| Name | Description |
| --- | --- |
| [read_fchk_g16](#pyvib.base.read_fchk_g16) | Read Hessian in `.fchk` files from Gaussian16. |

### read_fchk_g16 { #pyvib.base.read_fchk_g16 }
...
| Name        | Type           | Description                                      | Default    |
|-------------|----------------|--------------------------------------------------|------------|
| `file_path` | [str](`str`)   | Path to ``fchk`` file.                           | _required_ |
| `use_trans` | [bool](`bool`) | Use translational vector. Defaults to ``False``. | _required_ |
| `use_rot`   | [bool](`bool`) | Use rotatinal vector. Defaults to ``False``.     | _required_ |

#### Returns

| Type                                                                                                                                                                                                            | Description                     |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|
| [Tuple](`typing.Tuple`)\[[str](`str`), [np](`numpy`).[ndarray](`numpy.ndarray`), [np](`numpy`).[ndarray](`numpy.ndarray`), [np](`numpy`).[ndarray](`numpy.ndarray`), [np](`numpy`).[ndarray](`numpy.ndarray`)\] | multiple contents listed below. |
